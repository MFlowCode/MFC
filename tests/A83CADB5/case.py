#!/usr/bin/env python3
#
# tests/A83CADB5/case.py:
# 1D -> Phase Change model 5 -> 2 Fluid(s)

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/A83CADB5/case.py",
    description="tests/A83CADB5/case.py: 1D -> Phase Change model 5 -> 2 Fluid(s)",
