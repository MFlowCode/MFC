#!/usr/bin/env python3
#
# tests/622DEC78/case.py:
# 3D -> Bubbles -> Monopole -> bubble_model=2

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/622DEC78/case.py",
    description="tests/622DEC78/case.py: 3D -> Bubbles -> Monopole -> bubble_model=2",
