#!/usr/bin/env python3
#
# tests/32D0F235/case.py:
# 1D -> 1 Fluid(s) -> riemann_solver=1 -> wave_speeds=2

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/32D0F235/case.py",
    description="tests/32D0F235/case.py: 1D -> 1 Fluid(s) -> riemann_solver=1 -> wave_speeds=2",
