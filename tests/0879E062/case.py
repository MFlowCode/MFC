#!/usr/bin/env python3
#
# tests/0879E062/case.py:
# 1D -> 2 Fluid(s) -> riemann_solver=1 -> avg_state=1

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/0879E062/case.py",
    description="tests/0879E062/case.py: 1D -> 2 Fluid(s) -> riemann_solver=1 -> avg_state=1",
