#!/usr/bin/env python3
#
# tests/6F296065/case.py:
# 2D -> Phase Change model 5 -> 3 Fluid(s)

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/6F296065/case.py",
    description="tests/6F296065/case.py: 2D -> Phase Change model 5 -> 3 Fluid(s)",
