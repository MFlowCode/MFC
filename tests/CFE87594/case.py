#!/usr/bin/env python3
#
# tests/CFE87594/case.py:
# 2D -> Bubbles -> Monopole -> QBMM -> Non-polytropic

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/CFE87594/case.py",
    description="tests/CFE87594/case.py: 2D -> Bubbles -> Monopole -> QBMM -> Non-polytropic",
