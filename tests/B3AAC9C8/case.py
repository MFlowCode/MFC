#!/usr/bin/env python3
#
# tests/B3AAC9C8/case.py:
# 2D -> Axisymmetric -> Viscous -> weno_Re_flux

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/B3AAC9C8/case.py",
    description="tests/B3AAC9C8/case.py: 2D -> Axisymmetric -> Viscous -> weno_Re_flux",
