#!/usr/bin/env python3
#
# tests/02748F0F/case.py:
# 1D -> 1 Fluid(s) -> Viscous -> weno_Re_flux -> weno_avg

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/02748F0F/case.py",
    description="tests/02748F0F/case.py: 1D -> 1 Fluid(s) -> Viscous -> weno_Re_flux -> weno_avg",
