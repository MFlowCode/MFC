#!/usr/bin/env python3
#
# tests/E8C28D5B/case.py:
# 2D -> 1 Fluid(s) -> Viscous -> weno_Re_flux

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/E8C28D5B/case.py",
    description="tests/E8C28D5B/case.py: 2D -> 1 Fluid(s) -> Viscous -> weno_Re_flux",
