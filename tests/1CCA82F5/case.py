#!/usr/bin/env python3
#
# tests/1CCA82F5/case.py:
# 1D -> 2 Fluid(s) -> riemann_solver=1 -> mpp_lim

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/1CCA82F5/case.py",
    description="tests/1CCA82F5/case.py: 1D -> 2 Fluid(s) -> riemann_solver=1 -> mpp_lim",
