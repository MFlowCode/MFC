#!/usr/bin/env python3
#
# tests/A0B82851/case.py:
# 3D -> 2 Fluid(s) -> riemann_solver=2 -> mpp_lim

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/A0B82851/case.py",
    description="tests/A0B82851/case.py: 3D -> 2 Fluid(s) -> riemann_solver=2 -> mpp_lim",
