#!/usr/bin/env python3
#
# tests/FBF808BE/case.py:
# 2D -> 1 Fluid(s) -> riemann_solver=1 -> wave_speeds=2

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/FBF808BE/case.py",
    description="tests/FBF808BE/case.py: 2D -> 1 Fluid(s) -> riemann_solver=1 -> wave_speeds=2",
