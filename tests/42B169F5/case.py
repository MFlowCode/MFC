#!/usr/bin/env python3
#
# tests/42B169F5/case.py:
# 3D -> weno_order=5 -> mapped_weno=F -> mp_weno=T

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/42B169F5/case.py",
    description="tests/42B169F5/case.py: 3D -> weno_order=5 -> mapped_weno=F -> mp_weno=T",
