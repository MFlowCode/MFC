#!/usr/bin/env python3
#
# tests/9ACD5174/case.py:
# 3D -> 1 Fluid(s) -> riemann_solver=1 -> mixture_err

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/9ACD5174/case.py",
    description="tests/9ACD5174/case.py: 3D -> 1 Fluid(s) -> riemann_solver=1 -> mixture_err",
