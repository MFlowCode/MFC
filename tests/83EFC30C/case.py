#!/usr/bin/env python3
#
# tests/83EFC30C/case.py:
# 1D -> 2 Fluid(s) -> riemann_solver=1 -> wave_speeds=2

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/83EFC30C/case.py",
    description="tests/83EFC30C/case.py: 1D -> 2 Fluid(s) -> riemann_solver=1 -> wave_speeds=2",
