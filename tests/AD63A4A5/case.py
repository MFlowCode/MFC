#!/usr/bin/env python3
#
# tests/AD63A4A5/case.py:
# 3D -> Bubbles -> Monopole -> Polytropic -> bubble_model=2

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/AD63A4A5/case.py",
    description="tests/AD63A4A5/case.py: 3D -> Bubbles -> Monopole -> Polytropic -> bubble_model=2",
