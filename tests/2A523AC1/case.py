#!/usr/bin/env python3
#
# tests/2A523AC1/case.py:
# 3D -> 1 Fluid(s) -> riemann_solver=1 -> wave_speeds=2

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/2A523AC1/case.py",
    description="tests/2A523AC1/case.py: 3D -> 1 Fluid(s) -> riemann_solver=1 -> wave_speeds=2",
