#!/usr/bin/env python3
#
# tests/541A30DB/case.py:
# 3D -> Viscosity -> Bubbles -> bubble_model=2

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/541A30DB/case.py",
    description="tests/541A30DB/case.py: 3D -> Viscosity -> Bubbles -> bubble_model=2",
