#!/usr/bin/env python3
#
# tests/B3C85904/case.py:
# 1D -> weno_order=3 -> mapped_weno=F -> mp_weno=F

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/B3C85904/case.py",
    description="tests/B3C85904/case.py: 1D -> weno_order=3 -> mapped_weno=F -> mp_weno=F",
