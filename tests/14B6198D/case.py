#!/usr/bin/env python3
#
# tests/14B6198D/case.py:
# 2D -> Bubbles -> Monopole -> Polytropic -> bubble_model=2

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/14B6198D/case.py",
    description="tests/14B6198D/case.py: 2D -> Bubbles -> Monopole -> Polytropic -> bubble_model=2",
