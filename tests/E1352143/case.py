#!/usr/bin/env python3
#
# tests/E1352143/case.py:
# 3D -> weno_order=3 -> mapped_weno=F -> mp_weno=F

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/E1352143/case.py",
    description="tests/E1352143/case.py: 3D -> weno_order=3 -> mapped_weno=F -> mp_weno=F",
