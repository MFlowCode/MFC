#!/usr/bin/env python3
#
# tests/C4907722/case.py:
# 1D -> 2 Fluid(s) -> riemann_solver=2 -> mpp_lim

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/C4907722/case.py",
    description="tests/C4907722/case.py: 1D -> 2 Fluid(s) -> riemann_solver=2 -> mpp_lim",
