#!/usr/bin/env python3
#
# tests/A5C93D62/case.py:
# 2D -> 2 Fluid(s) -> riemann_solver=1 -> wave_speeds=2

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/A5C93D62/case.py",
    description="tests/A5C93D62/case.py: 2D -> 2 Fluid(s) -> riemann_solver=1 -> wave_speeds=2",
