#!/usr/bin/env python3
#
# tests/345A94C0/case.py:
# 2D -> 1 Fluid(s) -> riemann_solver=2 -> wave_speeds=2

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/345A94C0/case.py",
    description="tests/345A94C0/case.py: 2D -> 1 Fluid(s) -> riemann_solver=2 -> wave_speeds=2",
