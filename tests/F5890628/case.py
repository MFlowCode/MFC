#!/usr/bin/env python3
#
# tests/F5890628/case.py:
# 1D -> weno_order=5 -> mapped_weno=T -> mp_weno=F

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/F5890628/case.py",
    description="tests/F5890628/case.py: 1D -> weno_order=5 -> mapped_weno=T -> mp_weno=F",
