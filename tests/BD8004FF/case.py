#!/usr/bin/env python3
#
# tests/BD8004FF/case.py:
# 3D -> 2 Fluid(s) -> riemann_solver=1 -> wave_speeds=2

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/BD8004FF/case.py",
    description="tests/BD8004FF/case.py: 3D -> 2 Fluid(s) -> riemann_solver=1 -> wave_speeds=2",
