#!/usr/bin/env python3
#
# tests/C04741B4/case.py:
# 2D -> weno_order=5 -> mapped_weno=T -> mp_weno=F

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/C04741B4/case.py",
    description="tests/C04741B4/case.py: 2D -> weno_order=5 -> mapped_weno=T -> mp_weno=F",
