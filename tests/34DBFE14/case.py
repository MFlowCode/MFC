#!/usr/bin/env python3
#
# tests/34DBFE14/case.py:
# 2D -> Bubbles -> Monopole -> Polytropic -> bubble_model=3

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/34DBFE14/case.py",
    description="tests/34DBFE14/case.py: 2D -> Bubbles -> Monopole -> Polytropic -> bubble_model=3",
