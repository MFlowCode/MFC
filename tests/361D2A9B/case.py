#!/usr/bin/env python3
#
# tests/361D2A9B/case.py:
# 2D -> Viscosity -> Bubbles -> bubble_model=2

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/361D2A9B/case.py",
    description="tests/361D2A9B/case.py: 2D -> Viscosity -> Bubbles -> bubble_model=2",
