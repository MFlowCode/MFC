#!/usr/bin/env python3
#
# tests/461DCB09/case.py:
# 1D -> 2 Fluid(s) -> riemann_solver=2 -> wave_speeds=2

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/461DCB09/case.py",
    description="tests/461DCB09/case.py: 1D -> 2 Fluid(s) -> riemann_solver=2 -> wave_speeds=2",
