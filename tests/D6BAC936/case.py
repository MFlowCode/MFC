#!/usr/bin/env python3
#
# tests/D6BAC936/case.py:
# 2D -> 2 Fluid(s) -> Viscous -> weno_Re_flux

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/D6BAC936/case.py",
    description="tests/D6BAC936/case.py: 2D -> 2 Fluid(s) -> Viscous -> weno_Re_flux",
