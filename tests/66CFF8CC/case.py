#!/usr/bin/env python3
#
# tests/66CFF8CC/case.py:
# 2D -> Bubbles -> Monopole -> QBMM -> bubble_model=3

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/66CFF8CC/case.py",
    description="tests/66CFF8CC/case.py: 2D -> Bubbles -> Monopole -> QBMM -> bubble_model=3",
