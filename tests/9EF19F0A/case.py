#!/usr/bin/env python3
#
# tests/9EF19F0A/case.py:
# 1D -> Phase Change model 5 -> 3 Fluid(s)

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/9EF19F0A/case.py",
    description="tests/9EF19F0A/case.py: 1D -> Phase Change model 5 -> 3 Fluid(s)",
