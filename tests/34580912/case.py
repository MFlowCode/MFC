#!/usr/bin/env python3
#
# tests/34580912/case.py:
# 1D -> weno_order=5 -> mapped_weno=F -> mp_weno=T

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/34580912/case.py",
    description="tests/34580912/case.py: 1D -> weno_order=5 -> mapped_weno=F -> mp_weno=T",
