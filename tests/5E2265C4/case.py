#!/usr/bin/env python3
#
# tests/5E2265C4/case.py:
# 1D -> Viscosity -> Bubbles -> Polytropic -> bubble_model=3

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/5E2265C4/case.py",
    description="tests/5E2265C4/case.py: 1D -> Viscosity -> Bubbles -> Polytropic -> bubble_model=3",
