#!/usr/bin/env python3
#
# tests/2060F55A/case.py:
# 3D -> 2 Fluid(s) -> Viscous -> weno_Re_flux

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/2060F55A/case.py",
    description="tests/2060F55A/case.py: 3D -> 2 Fluid(s) -> Viscous -> weno_Re_flux",
