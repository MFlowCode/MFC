#!/usr/bin/env python3
#
# tests/5527832F/case.py:
# 1D -> 1 Fluid(s) -> riemann_solver=1 -> mixture_err

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/5527832F/case.py",
    description="tests/5527832F/case.py: 1D -> 1 Fluid(s) -> riemann_solver=1 -> mixture_err",
