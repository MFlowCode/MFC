#!/usr/bin/env python3
#
# tests/2A6136EF/case.py:
# 1D -> 2 Fluid(s) -> Viscous -> weno_Re_flux -> weno_avg

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/2A6136EF/case.py",
    description="tests/2A6136EF/case.py: 1D -> 2 Fluid(s) -> Viscous -> weno_Re_flux -> weno_avg",
