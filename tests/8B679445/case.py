#!/usr/bin/env python3
#
# tests/8B679445/case.py:
# 3D -> Viscosity -> Bubbles -> Polytropic -> bubble_model=2

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/8B679445/case.py",
    description="tests/8B679445/case.py: 3D -> Viscosity -> Bubbles -> Polytropic -> bubble_model=2",
