#!/usr/bin/env python3
#
# tests/3974AC7B/case.py:
# 2D -> weno_order=5 -> mapped_weno=F -> mp_weno=F

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/3974AC7B/case.py",
    description="tests/3974AC7B/case.py: 2D -> weno_order=5 -> mapped_weno=F -> mp_weno=F",
