#!/usr/bin/env python3
#
# tests/4A68980E/case.py:
# 3D -> Phase Change model 6 -> 3 Fluid(s)

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/4A68980E/case.py",
    description="tests/4A68980E/case.py: 3D -> Phase Change model 6 -> 3 Fluid(s)",
