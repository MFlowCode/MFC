#!/usr/bin/env python3
#
# tests/F1457D58/case.py:
# 3D -> Bubbles -> Monopole -> QBMM -> Non-polytropic

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/F1457D58/case.py",
    description="tests/F1457D58/case.py: 3D -> Bubbles -> Monopole -> QBMM -> Non-polytropic",
