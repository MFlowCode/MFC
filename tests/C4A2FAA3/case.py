#!/usr/bin/env python3
#
# tests/C4A2FAA3/case.py:
# 3D -> 2 Fluid(s) -> riemann_solver=1 -> mixture_err

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/C4A2FAA3/case.py",
    description="tests/C4A2FAA3/case.py: 3D -> 2 Fluid(s) -> riemann_solver=1 -> mixture_err",
