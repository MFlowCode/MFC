#!/usr/bin/env python3
#
# tests/13DFC31D/case.py:
# 3D -> weno_order=3 -> mapped_weno=T -> mp_weno=F

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/13DFC31D/case.py",
    description="tests/13DFC31D/case.py: 3D -> weno_order=3 -> mapped_weno=T -> mp_weno=F",
