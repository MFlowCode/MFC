#!/usr/bin/env python3
#
# tests/16FBF4C8/case.py:
# 2D -> 2 Fluid(s) -> riemann_solver=1 -> mixture_err

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/16FBF4C8/case.py",
    description="tests/16FBF4C8/case.py: 2D -> 2 Fluid(s) -> riemann_solver=1 -> mixture_err",
