#!/usr/bin/env python3
#
# tests/3A8359F6/case.py:
# 1D -> 2 Fluid(s) -> riemann_solver=2 -> mixture_err

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/3A8359F6/case.py",
    description="tests/3A8359F6/case.py: 1D -> 2 Fluid(s) -> riemann_solver=2 -> mixture_err",
