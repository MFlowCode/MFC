#!/usr/bin/env python3
#
# tests/842C6FFC/case.py:
# 1D -> Phase Change model 6 -> 2 Fluid(s)

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/842C6FFC/case.py",
    description="tests/842C6FFC/case.py: 1D -> Phase Change model 6 -> 2 Fluid(s)",
