#!/usr/bin/env python3
#
# tests/7374E266/case.py:
# 2D -> 1 Fluid(s) -> riemann_solver=1 -> mixture_err

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/7374E266/case.py",
    description="tests/7374E266/case.py: 2D -> 1 Fluid(s) -> riemann_solver=1 -> mixture_err",
