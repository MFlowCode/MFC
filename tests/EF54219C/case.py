#!/usr/bin/env python3
#
# tests/EF54219C/case.py:
# 1D -> Bubbles -> Monopole -> Polytropic -> bubble_model=3

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/EF54219C/case.py",
    description="tests/EF54219C/case.py: 1D -> Bubbles -> Monopole -> Polytropic -> bubble_model=3",
