#!/usr/bin/env python3
#
# tests/8E3D99E6/case.py:
# 1D -> 1 Fluid(s) -> Viscous -> weno_Re_flux

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/8E3D99E6/case.py",
    description="tests/8E3D99E6/case.py: 1D -> 1 Fluid(s) -> Viscous -> weno_Re_flux",
