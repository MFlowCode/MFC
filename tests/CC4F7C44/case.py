#!/usr/bin/env python3
#
# tests/CC4F7C44/case.py:
# 2D -> Bubbles -> Monopole -> bubble_model=2

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/CC4F7C44/case.py",
    description="tests/CC4F7C44/case.py: 2D -> Bubbles -> Monopole -> bubble_model=2",
