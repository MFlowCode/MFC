#!/usr/bin/env python3
#
# tests/AACF1BC5/case.py:
# 3D -> 2 Fluid(s) -> riemann_solver=2 -> mixture_err

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/AACF1BC5/case.py",
    description="tests/AACF1BC5/case.py: 3D -> 2 Fluid(s) -> riemann_solver=2 -> mixture_err",
