#!/usr/bin/env python3
#
# tests/6B22A317/case.py:
# 1D -> Bubbles -> Monopole -> bubble_model=2

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/6B22A317/case.py",
    description="tests/6B22A317/case.py: 1D -> Bubbles -> Monopole -> bubble_model=2",
