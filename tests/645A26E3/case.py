#!/usr/bin/env python3
#
# tests/645A26E3/case.py:
# 2D -> 2 Fluid(s) -> riemann_solver=2 -> avg_state=1

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/645A26E3/case.py",
    description="tests/645A26E3/case.py: 2D -> 2 Fluid(s) -> riemann_solver=2 -> avg_state=1",
