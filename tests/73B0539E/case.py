#!/usr/bin/env python3
#
# tests/73B0539E/case.py:
# 3D -> 1 Fluid(s) -> riemann_solver=1 -> avg_state=1

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/73B0539E/case.py",
    description="tests/73B0539E/case.py: 3D -> 1 Fluid(s) -> riemann_solver=1 -> avg_state=1",
