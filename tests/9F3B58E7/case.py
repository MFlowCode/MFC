#!/usr/bin/env python3
#
# tests/9F3B58E7/case.py:
# 2D -> Viscosity -> Bubbles -> Polytropic -> bubble_model=2

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/9F3B58E7/case.py",
    description="tests/9F3B58E7/case.py: 2D -> Viscosity -> Bubbles -> Polytropic -> bubble_model=2",
