#!/usr/bin/env python3
#
# tests/38533D07/case.py:
# 3D -> Viscosity -> Bubbles -> Polytropic -> bubble_model=3

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/38533D07/case.py",
    description="tests/38533D07/case.py: 3D -> Viscosity -> Bubbles -> Polytropic -> bubble_model=3",
