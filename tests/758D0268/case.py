#!/usr/bin/env python3
#
# tests/758D0268/case.py:
# 3D -> 2 Fluid(s) -> riemann_solver=1 -> mpp_lim

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/758D0268/case.py",
    description="tests/758D0268/case.py: 3D -> 2 Fluid(s) -> riemann_solver=1 -> mpp_lim",
