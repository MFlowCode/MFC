#!/usr/bin/env python3
#
# tests/967760CB/case.py:
# 2D -> Phase Change model 6 -> 2 Fluid(s)

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/967760CB/case.py",
    description="tests/967760CB/case.py: 2D -> Phase Change model 6 -> 2 Fluid(s)",
