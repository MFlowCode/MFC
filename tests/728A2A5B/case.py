#!/usr/bin/env python3
#
# tests/728A2A5B/case.py:
# 3D -> weno_order=5 -> mapped_weno=F -> mp_weno=F

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/728A2A5B/case.py",
    description="tests/728A2A5B/case.py: 3D -> weno_order=5 -> mapped_weno=F -> mp_weno=F",
