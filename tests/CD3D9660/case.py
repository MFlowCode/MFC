#!/usr/bin/env python3
#
# tests/CD3D9660/case.py:
# 2D -> weno_order=3 -> mapped_weno=T -> mp_weno=F

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/CD3D9660/case.py",
    description="tests/CD3D9660/case.py: 2D -> weno_order=3 -> mapped_weno=T -> mp_weno=F",
