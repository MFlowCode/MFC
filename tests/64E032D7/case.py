#!/usr/bin/env python3
#
# tests/64E032D7/case.py:
# 3D -> 1 Fluid(s) -> Viscous -> weno_Re_flux

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/64E032D7/case.py",
    description="tests/64E032D7/case.py: 3D -> 1 Fluid(s) -> Viscous -> weno_Re_flux",
