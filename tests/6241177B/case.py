#!/usr/bin/env python3
#
# tests/6241177B/case.py:
# 3D -> 1 Fluid(s) -> riemann_solver=2 -> model_eqns=3

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/6241177B/case.py",
    description="tests/6241177B/case.py: 3D -> 1 Fluid(s) -> riemann_solver=2 -> model_eqns=3",
