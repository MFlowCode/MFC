#!/usr/bin/env python3
#
# tests/48B9D0C4/case.py:
# 3D -> Viscosity -> Bubbles -> QBMM -> bubble_model=3

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/48B9D0C4/case.py",
    description="tests/48B9D0C4/case.py: 3D -> Viscosity -> Bubbles -> QBMM -> bubble_model=3",
