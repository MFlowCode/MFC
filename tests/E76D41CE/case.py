#!/usr/bin/env python3
#
# tests/E76D41CE/case.py:
# 2D -> weno_order=5 -> mapped_weno=F -> mp_weno=T

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/E76D41CE/case.py",
    description="tests/E76D41CE/case.py: 2D -> weno_order=5 -> mapped_weno=F -> mp_weno=T",
