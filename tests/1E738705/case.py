#!/usr/bin/env python3
#
# tests/1E738705/case.py:
# 1D -> 2 Fluid(s) -> riemann_solver=1 -> mixture_err

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/1E738705/case.py",
    description="tests/1E738705/case.py: 1D -> 2 Fluid(s) -> riemann_solver=1 -> mixture_err",
