#!/usr/bin/env python3
#
# tests/83291843/case.py:
# 2D -> Viscosity -> Bubbles -> QBMM -> bubble_model=3

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/83291843/case.py",
    description="tests/83291843/case.py: 2D -> Viscosity -> Bubbles -> QBMM -> bubble_model=3",
