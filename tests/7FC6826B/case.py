#!/usr/bin/env python3
#
# tests/7FC6826B/case.py:
# 1D -> Bubbles -> Monopole -> Polytropic -> bubble_model=2

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/7FC6826B/case.py",
    description="tests/7FC6826B/case.py: 1D -> Bubbles -> Monopole -> Polytropic -> bubble_model=2",
