#!/usr/bin/env python3
#
# tests/4F2F4ACE/case.py:
# 2D -> 2 Fluid(s) -> riemann_solver=2 -> model_eqns=3

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/4F2F4ACE/case.py",
    description="tests/4F2F4ACE/case.py: 2D -> 2 Fluid(s) -> riemann_solver=2 -> model_eqns=3",
