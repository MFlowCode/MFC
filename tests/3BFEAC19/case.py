#!/usr/bin/env python3
#
# tests/3BFEAC19/case.py:
# 2D -> 1 Fluid(s) -> riemann_solver=1 -> avg_state=1

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/3BFEAC19/case.py",
    description="tests/3BFEAC19/case.py: 2D -> 1 Fluid(s) -> riemann_solver=1 -> avg_state=1",
