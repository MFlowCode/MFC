#!/usr/bin/env python3
#
# tests/84017671/case.py:
# 1D -> weno_order=5 -> mapped_weno=F -> mp_weno=F

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/84017671/case.py",
    description="tests/84017671/case.py: 1D -> weno_order=5 -> mapped_weno=F -> mp_weno=F",
