#!/usr/bin/env python3
#
# tests/B057C4F4/case.py:
# 3D -> Phase Change model 6 -> 2 Fluid(s)

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/B057C4F4/case.py",
    description="tests/B057C4F4/case.py: 3D -> Phase Change model 6 -> 2 Fluid(s)",
