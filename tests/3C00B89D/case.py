#!/usr/bin/env python3
#
# tests/3C00B89D/case.py:
# 2D -> 1 Fluid(s) -> riemann_solver=2 -> avg_state=1

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/3C00B89D/case.py",
    description="tests/3C00B89D/case.py: 2D -> 1 Fluid(s) -> riemann_solver=2 -> avg_state=1",
