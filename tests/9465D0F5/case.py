#!/usr/bin/env python3
#
# tests/9465D0F5/case.py:
# 1D -> Viscosity -> Bubbles -> Polytropic -> bubble_model=2

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/9465D0F5/case.py",
    description="tests/9465D0F5/case.py: 1D -> Viscosity -> Bubbles -> Polytropic -> bubble_model=2",
