#!/usr/bin/env python3
#
# tests/2E021372/case.py:
# 2D -> Viscosity -> Bubbles -> Polytropic -> bubble_model=3

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/2E021372/case.py",
    description="tests/2E021372/case.py: 2D -> Viscosity -> Bubbles -> Polytropic -> bubble_model=3",
