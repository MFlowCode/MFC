#!/usr/bin/env python3
#
# tests/E4EFEDB2/case.py:
# 2D -> weno_order=3 -> mapped_weno=F -> mp_weno=F

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/E4EFEDB2/case.py",
    description="tests/E4EFEDB2/case.py: 2D -> weno_order=3 -> mapped_weno=F -> mp_weno=F",
