#!/usr/bin/env python3
#
# tests/5781A4C2/case.py:
# 2D -> 2 Fluid(s) -> riemann_solver=2 -> mixture_err

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/5781A4C2/case.py",
    description="tests/5781A4C2/case.py: 2D -> 2 Fluid(s) -> riemann_solver=2 -> mixture_err",
