#!/usr/bin/env python3
#
# tests/18431ACB/case.py:
# 3D -> Phase Change model 5 -> 3 Fluid(s)

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/18431ACB/case.py",
    description="tests/18431ACB/case.py: 3D -> Phase Change model 5 -> 3 Fluid(s)",
