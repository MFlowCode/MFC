#!/usr/bin/env python3
#
# tests/B33E256A/case.py:
# 3D -> 2 Fluid(s) -> riemann_solver=2 -> avg_state=1

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/B33E256A/case.py",
    description="tests/B33E256A/case.py: 3D -> 2 Fluid(s) -> riemann_solver=2 -> avg_state=1",
