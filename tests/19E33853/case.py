#!/usr/bin/env python3
#
# tests/19E33853/case.py:
# 3D -> weno_order=5 -> mapped_weno=T -> mp_weno=F

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/19E33853/case.py",
    description="tests/19E33853/case.py: 3D -> weno_order=5 -> mapped_weno=T -> mp_weno=F",
