#!/usr/bin/env python3
#
# tests/6D24B115/case.py:
# 1D -> 2 Fluid(s) -> riemann_solver=2 -> avg_state=1

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/6D24B115/case.py",
    description="tests/6D24B115/case.py: 1D -> 2 Fluid(s) -> riemann_solver=2 -> avg_state=1",
