#!/usr/bin/env python3
#
# tests/F0E6771E/case.py:
# 3D -> 2 Fluid(s) -> riemann_solver=2 -> model_eqns=3

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/F0E6771E/case.py",
    description="tests/F0E6771E/case.py: 3D -> 2 Fluid(s) -> riemann_solver=2 -> model_eqns=3",
