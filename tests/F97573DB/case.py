#!/usr/bin/env python3
#
# tests/F97573DB/case.py:
# 1D -> 1 Fluid(s) -> riemann_solver=2 -> avg_state=1

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/F97573DB/case.py",
    description="tests/F97573DB/case.py: 1D -> 1 Fluid(s) -> riemann_solver=2 -> avg_state=1",
