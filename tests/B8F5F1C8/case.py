#!/usr/bin/env python3
#
# tests/B8F5F1C8/case.py:
# 3D -> 2 Fluid(s) -> riemann_solver=2 -> wave_speeds=2

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/B8F5F1C8/case.py",
    description="tests/B8F5F1C8/case.py: 3D -> 2 Fluid(s) -> riemann_solver=2 -> wave_speeds=2",
