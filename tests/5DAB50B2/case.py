#!/usr/bin/env python3
#
# tests/5DAB50B2/case.py:
# 2D -> 2 Fluid(s) -> riemann_solver=2 -> alt_soundspeed

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/5DAB50B2/case.py",
    description="tests/5DAB50B2/case.py: 2D -> 2 Fluid(s) -> riemann_solver=2 -> alt_soundspeed",
