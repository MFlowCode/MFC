#!/usr/bin/env python3
#
# tests/786DE444/case.py:
# 1D -> Phase Change model 6 -> 3 Fluid(s)

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/786DE444/case.py",
    description="tests/786DE444/case.py: 1D -> Phase Change model 6 -> 3 Fluid(s)",
...
case = {
    ...
    "patch_icpp(1)%alpha(2)": 0.025893,
    "patch_icpp(1)%alpha_rho(2)": 0.059895687600000004,
    "patch_icpp(2)%alpha(2)": 0.028728,
    "patch_icpp(2)%alpha_rho(2)": 0.016670858400000002,
    "patch_icpp(3)%alpha(2)": 0.028728,
    "patch_icpp(3)%alpha_rho(2)": 0.016670858400000002,
    "fluid_pp(3)%gamma": 2.487,
    "fluid_pp(3)%pi_inf": 0.0,
    "fluid_pp(3)%cv": 717.5,
    "fluid_pp(3)%qv": 0.0,
    "fluid_pp(3)%qvp": 0.0,
    "patch_icpp(1)%alpha(3)": 0.9740982851,
    "patch_icpp(1)%alpha_rho(3)": 3.4911682537984,
    "patch_icpp(2)%alpha(3)": 0.9712352510000001,
    "patch_icpp(2)%alpha_rho(3)": 0.8732376141741001,
    "patch_icpp(3)%alpha(3)": 0.9712352510000001,
    "patch_icpp(3)%alpha_rho(3)": 0.8732376141741001
}
mods = {}
