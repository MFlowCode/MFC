#!/usr/bin/env python3
#
# tests/50A8B1FE/case.py:
# 1D -> Bubbles -> Monopole -> QBMM -> Non-polytropic

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/50A8B1FE/case.py",
    description="tests/50A8B1FE/case.py: 1D -> Bubbles -> Monopole -> QBMM -> Non-polytropic",
