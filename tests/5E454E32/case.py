#!/usr/bin/env python3
#
# tests/5E454E32/case.py:
# 2D -> 2 Fluid(s) -> Viscous -> weno_Re_flux -> weno_avg

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/5E454E32/case.py",
    description="tests/5E454E32/case.py: 2D -> 2 Fluid(s) -> Viscous -> weno_Re_flux -> weno_avg",
