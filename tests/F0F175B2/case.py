#!/usr/bin/env python3
#
# tests/F0F175B2/case.py:
# 2D -> 2 Fluid(s) -> riemann_solver=2 -> mpp_lim

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/F0F175B2/case.py",
    description="tests/F0F175B2/case.py: 2D -> 2 Fluid(s) -> riemann_solver=2 -> mpp_lim",
