#!/usr/bin/env python3
#
# tests/AB0BE4E4/case.py:
# 3D -> 1 Fluid(s) -> riemann_solver=2 -> avg_state=1

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/AB0BE4E4/case.py",
    description="tests/AB0BE4E4/case.py: 3D -> 1 Fluid(s) -> riemann_solver=2 -> avg_state=1",
