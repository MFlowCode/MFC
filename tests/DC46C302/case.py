#!/usr/bin/env python3
#
# tests/DC46C302/case.py:
# 1D -> Bubbles -> Monopole -> QBMM -> bubble_model=3 -> Non-polytropic

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/DC46C302/case.py",
    description="tests/DC46C302/case.py: 1D -> Bubbles -> Monopole -> QBMM -> bubble_model=3 -> Non-polytropic",
