#!/usr/bin/env python3
#
# tests/AF46C382/case.py:
# 1D -> Bubbles -> Monopole -> QBMM -> bubble_model=3

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/AF46C382/case.py",
    description="tests/AF46C382/case.py: 1D -> Bubbles -> Monopole -> QBMM -> bubble_model=3",
