#!/usr/bin/env python3
#
# tests/C06849AD/case.py:
# 3D -> 1 Fluid(s) -> riemann_solver=2 -> mixture_err

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/C06849AD/case.py",
    description="tests/C06849AD/case.py: 3D -> 1 Fluid(s) -> riemann_solver=2 -> mixture_err",
