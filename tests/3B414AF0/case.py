#!/usr/bin/env python3
#
# tests/3B414AF0/case.py:
# 2D -> 1 Fluid(s) -> riemann_solver=2 -> mixture_err

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/3B414AF0/case.py",
    description="tests/3B414AF0/case.py: 2D -> 1 Fluid(s) -> riemann_solver=2 -> mixture_err",
