#!/usr/bin/env python3
#
# tests/D3C860B9/case.py:
# 2D -> Phase Change model 6 -> 3 Fluid(s)

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/D3C860B9/case.py",
    description="tests/D3C860B9/case.py: 2D -> Phase Change model 6 -> 3 Fluid(s)",
