#!/usr/bin/env python3
#
# tests/72FD6FF5/case.py:
# 3D -> Phase Change model 5 -> 2 Fluid(s)

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/72FD6FF5/case.py",
    description="tests/72FD6FF5/case.py: 3D -> Phase Change model 5 -> 2 Fluid(s)",
