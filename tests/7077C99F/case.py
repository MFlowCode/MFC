#!/usr/bin/env python3
#
# tests/7077C99F/case.py:
# 1D -> weno_order=3 -> mapped_weno=T -> mp_weno=F

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/7077C99F/case.py",
    description="tests/7077C99F/case.py: 1D -> weno_order=3 -> mapped_weno=T -> mp_weno=F",
