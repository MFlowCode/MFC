#!/usr/bin/env python3
#
# tests/DC9CB97E/case.py:
# 2D -> 2 Fluid(s) -> riemann_solver=1 -> avg_state=1

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/DC9CB97E/case.py",
    description="tests/DC9CB97E/case.py: 2D -> 2 Fluid(s) -> riemann_solver=1 -> avg_state=1",
