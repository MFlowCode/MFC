#!/usr/bin/env python3
#
# tests/851F7AE2/case.py:
# 3D -> 2 Fluid(s) -> riemann_solver=1 -> avg_state=1

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/851F7AE2/case.py",
    description="tests/851F7AE2/case.py: 3D -> 2 Fluid(s) -> riemann_solver=1 -> avg_state=1",
