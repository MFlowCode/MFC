#!/usr/bin/env python3
#
# tests/53E13D19/case.py:
# 1D -> Viscosity -> Bubbles -> QBMM -> bubble_model=3

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/53E13D19/case.py",
    description="tests/53E13D19/case.py: 1D -> Viscosity -> Bubbles -> QBMM -> bubble_model=3",
