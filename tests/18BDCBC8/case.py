#!/usr/bin/env python3
#
# tests/18BDCBC8/case.py:
# 1D -> 1 Fluid(s) -> riemann_solver=2 -> mixture_err

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/18BDCBC8/case.py",
    description="tests/18BDCBC8/case.py: 1D -> 1 Fluid(s) -> riemann_solver=2 -> mixture_err",
