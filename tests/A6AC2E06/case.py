#!/usr/bin/env python3
#
# tests/A6AC2E06/case.py:
# 2D -> 2 Fluid(s) -> riemann_solver=1 -> mpp_lim

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/A6AC2E06/case.py",
    description="tests/A6AC2E06/case.py: 2D -> 2 Fluid(s) -> riemann_solver=1 -> mpp_lim",
