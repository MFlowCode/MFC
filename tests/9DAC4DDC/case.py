#!/usr/bin/env python3
#
# tests/9DAC4DDC/case.py:
# 1D -> 2 Fluid(s) -> riemann_solver=2 -> alt_soundspeed

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/9DAC4DDC/case.py",
    description="tests/9DAC4DDC/case.py: 1D -> 2 Fluid(s) -> riemann_solver=2 -> alt_soundspeed",
