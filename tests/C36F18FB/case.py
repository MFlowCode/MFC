#!/usr/bin/env python3
#
# tests/C36F18FB/case.py:
# 3D -> 1 Fluid(s) -> riemann_solver=2 -> wave_speeds=2

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/C36F18FB/case.py",
    description="tests/C36F18FB/case.py: 3D -> 1 Fluid(s) -> riemann_solver=2 -> wave_speeds=2",
