#!/usr/bin/env python3
#
# tests/FC4D07B6/case.py:
# 2D -> 2 Fluid(s) -> riemann_solver=2 -> wave_speeds=2

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/FC4D07B6/case.py",
    description="tests/FC4D07B6/case.py: 2D -> 2 Fluid(s) -> riemann_solver=2 -> wave_speeds=2",
