#!/usr/bin/env python3
#
# tests/2F35A1FE/case.py:
# 1D -> 1 Fluid(s) -> riemann_solver=2 -> model_eqns=3

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/2F35A1FE/case.py",
    description="tests/2F35A1FE/case.py: 1D -> 1 Fluid(s) -> riemann_solver=2 -> model_eqns=3",
