#!/usr/bin/env python3
#
# tests/DA8AF07E/case.py:
# 2D -> Phase Change model 5 -> 2 Fluid(s)

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/DA8AF07E/case.py",
    description="tests/DA8AF07E/case.py: 2D -> Phase Change model 5 -> 2 Fluid(s)",
