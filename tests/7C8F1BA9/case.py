#!/usr/bin/env python3
#
# tests/7C8F1BA9/case.py:
# 3D -> 2 Fluid(s) -> riemann_solver=2 -> alt_soundspeed

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/7C8F1BA9/case.py",
    description="tests/7C8F1BA9/case.py: 3D -> 2 Fluid(s) -> riemann_solver=2 -> alt_soundspeed",
