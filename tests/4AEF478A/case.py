#!/usr/bin/env python3
#
# tests/4AEF478A/case.py:
# 1D -> 1 Fluid(s) -> riemann_solver=1 -> avg_state=1

import json
import argparse

parser = argparse.ArgumentParser(
    prog="tests/4AEF478A/case.py",
    description="tests/4AEF478A/case.py: 1D -> 1 Fluid(s) -> riemann_solver=1 -> avg_state=1",
