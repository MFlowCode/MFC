...
sed "s/\"amdgpu-flat-work-group-size\"\=\"1,1024\"/\"amdgpu-flat-work-group-size\"\=\"1,${WGSIZE}\"/g" build/simulation/simulation-cce-openmp-pre-llc.bc > build/simulation/simulation-cce-openmp-pre-llc-wg${WGSIZE}.ll
