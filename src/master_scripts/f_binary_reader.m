% MFC v3.0 - Master Scripts: f_binary_reader.m
% Description: The following function takes care of reading the binary database
...
% Description: See the description information in the file's header
