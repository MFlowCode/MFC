...
!$acc update device(q_cons_ts(1)%vf(i)%sf)
        ...
        print *, q_cons_ts(1)%vf(cont_idx%beg)%sf(312,0,0)
        print *, q_cons_ts(1)%vf(E_idx)%sf(312,0,0)
        print *, q_cons_ts(1)%vf(adv_idx%end)%sf(312,0,0)
        print *, q_cons_ts(1)%vf(mom_idx%beg)%sf(312,0,0)
