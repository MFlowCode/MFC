...
module m_data_output
    ...
    $:DECLARE(create=["icfl_sf","vcfl_sf","ccfl_sf","Rc_sf"])
    ...
    $:DECLARE(create=["icfl_max_loc","icfl_max_glb","vcfl_max_loc","vcfl_max_glb"])
    $:DECLARE(create=["ccfl_max_loc","ccfl_max_glb","Rc_min_loc","Rc_min_glb"])
