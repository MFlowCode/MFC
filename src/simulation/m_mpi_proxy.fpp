...
contains
    ...
    subroutine s_initialize_mpi_proxy()
    ...
    end subroutine s_initialize_mpi_proxy
    ...
    subroutine s_mpi_sendrecv_ib_buffers(c_divs_vf, gp_layers)
    ...
    subroutine s_finalize_mpi_proxy()
