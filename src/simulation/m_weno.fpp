                ...
                elseif (weno_order == 5) then
                    ...
                    if (.not. teno) then
                        ...
                        do i = is%beg - 1 + weno_polyn, is%end - 1 - weno_polyn
                            ...
                            poly_coef_cbR_${XYZ}$ (i + 1, 0, 0) = 1d0/12d0
                            poly_coef_cbR_${XYZ}$ (i + 1, 0, 1) = -4d0/12d0
                            poly_coef_cbR_${XYZ}$ (i + 1, 0, 2) = 9d0/12d0
                            poly_coef_cbR_${XYZ}$ (i + 1, 1, 0) = -1d0/12d0
                            poly_coef_cbR_${XYZ}$ (i + 1, 1, 1) = 6d0/12d0
                            poly_coef_cbR_${XYZ}$ (i + 1, 1, 2) = 1d0/12d0
                            poly_coef_cbR_${XYZ}$ (i + 1, 2, 0) = 3d0/12d0
                            poly_coef_cbR_${XYZ}$ (i + 1, 2, 1) = 4d0/12d0
                            poly_coef_cbR_${XYZ}$ (i + 1, 2, 2) = -1d0/12d0
                            poly_coef_cbR_${XYZ}$ (i + 1, 3, 0) = 13d0/12d0
                            ...
                            beta_coef_${XYZ}$ (i + 1, 3, 2) = 1854d0/240d0
                            beta_coef_${XYZ}$ (i + 1, 3, 3) = 3708d0/240d0
                            beta_coef_${XYZ}$ (i + 1, 3, 4) = -2788d0/240d0
                            beta_coef_${XYZ}$ (i + 1, 3, 5) = 547d0/240d0

                            beta_coef_${XYZ}$ (i + 1, 2, 0) = 547d0/240d0
                            beta_coef_${XYZ}$ (i + 1, 2, 1) = -1428d0/240d0
                            beta_coef_${XYZ}$ (i + 1, 2, 2) = 494d0/240d0
                            beta_coef_${XYZ}$ (i + 1, 2, 3) = 1468d0/240d0
                            beta_coef_${XYZ}$ (i + 1, 2, 4) = -1108d0/240d0
                            beta_coef_${XYZ}$ (i + 1, 2, 5) = 267d0/240d0

                            beta_coef_${XYZ}$ (i + 1, 1, 0) = 267d0/240d0
                            beta_coef_${XYZ}$ (i + 1, 1, 1) = -1108d0/240d0
                            beta_coef_${XYZ}$ (i + 1, 1, 2) = 494d0/240d0
                            beta_coef_${XYZ}$ (i + 1, 1, 3) = 1468d0/240d0
                            beta_coef_${XYZ}$ (i + 1, 1, 4) = -1428d0/240d0
                            beta_coef_${XYZ}$ (i + 1, 1, 5) = 547d0/240d0

                            beta_coef_${XYZ}$ (i + 1, 0, 0) = 547d0/240d0
                            beta_coef_${XYZ}$ (i + 1, 0, 1) = -2788d0/240d0
                            beta_coef_${XYZ}$ (i + 1, 0, 2) = 1854d0/240d0
                            beta_coef_${XYZ}$ (i + 1, 0, 3) = 3708d0/240d0
                            beta_coef_${XYZ}$ (i + 1, 0, 4) = -5188d0/240d0
                            beta_coef_${XYZ}$ (i + 1, 0, 5) = 2107d0/240d0
