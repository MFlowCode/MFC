...
#:endif
    ...
    subroutine s_perform_time_step(t_step, time_avg)
    ...
    subroutine s_save_performance_metrics(time_avg, time_final, io_time_avg, io_time_final, proc_time, io_proc_time, file_exists)
