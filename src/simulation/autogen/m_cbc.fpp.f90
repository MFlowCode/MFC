# 1 "/Users/benwilfong/Documents/software/MFC-Wilfong/src/simulation/m_cbc.fpp"
!>
!! @file m_cbc.f90
...
# 22 "/Users/benwilfong/Documents/software/MFC-Wilfong/src/simulation/m_cbc.fpp" 2
...
# 462 "/Users/benwilfong/Documents/software/MFC-Wilfong/src/simulation/m_cbc.fpp"
        if (cbc_dir == 1) then
            if (weno_order == 1) then
...
# 531 "/Users/benwilfong/Documents/software/MFC-Wilfong/src/simulation/m_cbc.fpp"
...
# 683 "/Users/benwilfong/Documents/software/MFC-Wilfong/src/simulation/m_cbc.fpp"
        if (cbc_dir == 1) then
...
# 814 "/Users/benwilfong/Documents/software/MFC-Wilfong/src/simulation/m_cbc.fpp"
...
# 814 "/Users/benwilfong/Documents/software/MFC-Wilfong/src/simulation/m_cbc.fpp"
        do q = 1, num_fluids 
# 814 "/Users/benwilfong/Documents/software/MFC-Wilfong/src/simulation/m_cbc.fpp"
            c = c + q_prim_rsx_vf(0, k, r, q + advxb - 1)*(1d0/gammas(q) + 1d0)* & 
# 814 "/Users/benwilfong/Documents/software/MFC-Wilfong/src/simulation/m_cbc.fpp"
                (q_prim_rsx_vf(0, k, r, E_idx) + pi_infs(q)/(gammas(q) + 1d0)) 
# 814 "/Users/benwilfong/Documents/software/MFC-Wilfong/src/simulation/m_cbc.fpp"
        end do 
# 814 "/Users/benwilfong/Documents/software/MFC-Wilfong/src/simulation/m_cbc.fpp"
        c = c/rho
...
# 816 "/Users/benwilfong/Documents/software/MFC-Wilfong/src/simulation/m_cbc.fpp"
    ...
    call s_compute_supersonic_outflow_L(dflt_int, lambda, L, rho, c, mf, dalpha_rho_ds, dpres_ds, dvel_ds, dadv_ds) ! --------------
                    ...
                    if (riemann_solver == 1) then
                        ...
                        !$acc loop seq
                        do i = advxb, advxe
                            flux_src_rsx_vf(-1, k, r, i) = flux_src_rsx_vf(0, k, r, i)
                        end do
...
# 814 "/Users/benwilfong/Documents/software/MFC-Wilfong/src/simulation/m_cbc.fpp"
        do q = 1, num_fluids 
# 814 "/Users/benwilfong/Documents/software/MFC-Wilfong/src/simulation/m_cbc.fpp"
            c = c + q_prim_rsy_vf(0, k, r, q + advxb - 1)*(1d0/gammas(q) + 1d0)* & 
# 814 "/Users/benwilfong/Documents/software/MFC-Wilfong/src/simulation/m_cbc.fpp"
                (q_prim_rsy_vf(0, k, r, E_idx) + pi_infs(q)/(gammas(q) + 1d0)) 
# 814 "/Users/benwilfong/Documents/software/MFC-Wilfong/src/simulation/m_cbc.fpp"
        end do 
# 814 "/Users/benwilfong/Documents/software/MFC-Wilfong/src/simulation/m_cbc.fpp"
        c = c/rho
...
# 816 "/Users/benwilfong/Documents/software/MFC-Wilfong/src/simulation/m_cbc.fpp"
    ...
    call s_compute_supersonic_outflow_L(dflt_int, lambda, L, rho, c, mf, dalpha_rho_ds, dpres_ds, dvel_ds, dadv_ds) ! --------------
                    ...
                    if (riemann_solver == 1) then
                        ...
                        !$acc loop seq
                        do i = advxb, advxe
                            flux_src_rsy_vf(-1, k, r, i) = flux_src_rsy_vf(0, k, r, i)
                        end do
...
# 814 "/Users/benwilfong/Documents/software/MFC-Wilfong/src/simulation/m_cbc.fpp"
        do q = 1, num_fluids 
# 814 "/Users/benwilfong/Documents/software/MFC-Wilfong/src/simulation/m_cbc.fpp"
            c = c + q_prim_rsz_vf(0, k, r, q + advxb - 1)*(1d0/gammas(q) + 1d0)* & 
# 814 "/Users/benwilfong/Documents/software/MFC-Wilfong/src/simulation/m_cbc.fpp"
                (q_prim_rsz_vf(0, k, r, E_idx) + pi_infs(q)/(gammas(q) + 1d0)) 
# 814 "/Users/benwilfong/Documents/software/MFC-Wilfong/src/simulation/m_cbc.fpp"
        end do 
# 814 "/Users/benwilfong/Documents/software/MFC-Wilfong/src/simulation/m_cbc.fpp"
        c = c/rho
...
# 816 "/Users/benwilfong/Documents/software/MFC-Wilfong/src/simulation/m_cbc.fpp"
    ...
    call s_compute_supersonic_outflow_L(dflt_int, lambda, L, rho, c, mf, dalpha_rho_ds, dpres_ds, dvel_ds, dadv_ds) ! --------------
                    ...
                    if (riemann_solver == 1) then
                        ...
                        !$acc loop seq
                        do i = advxb, advxe
                            flux_src_rsz_vf(-1, k, r, i) = flux_src_rsz_vf(0, k, r, i)
                        end do
...
# 1005 "/Users/benwilfong/Documents/software/MFC-Wilfong/src/simulation/m_cbc.fpp"
