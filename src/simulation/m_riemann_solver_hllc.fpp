                ...
                if (model_eqns == model_eqns_6eq) then
                    ...
                    do l = ${Z_BND}$%beg, ${Z_BND}$%end
                        do k = ${Y_BND}$%beg, ${Y_BND}$%end
                            do j = ${X_BND}$%beg, ${X_BND}$%end
                                ...
                                eos_s_avg = eos_state(rho_avg, pres_R, gamma_avg, pi_inf_R, qv_avg, vel_avg_rms, H_avg, 0._wp)
                    ...
                    #:for HYPO in [True, False]
                        ...
                        #:if HYPO
                            ...
                            #:set _hllc_p3 = 'F_HLL, u_n_HLL_trace, u_t_HLL_trace, u_t2_HLL_trace, p_face_HLL, tau_qq_face_HLL, tau_nn_HLL, phi, Sigma_L, Sigma_R, dSigma, Sigma_ref, a_L_ref, a_R_ref, a_ref, du_t, dtau_nt, du_t2, dtau_nt2, sensor_ptot, sensor_vt, sensor_tnt, sensor_combined, idx_phys, eos_s_L, eos_s_R, eos_s_avg]'
                        ...
                        do l = ${Z_BND}$%beg, ${Z_BND}$%end
                            do k = ${Y_BND}$%beg, ${Y_BND}$%end
                                do j = ${X_BND}$%beg, ${X_BND}$%end
                                    ...
                                    !> The computation of c_avg does not require all the variables, and therefore the non '_avg'
                                    !  variables are placeholders to call the subroutine.
                                    eos_s_avg = eos_state(rho_avg, pres_R, gamma_avg, pi_inf_R, qv_avg, vel_avg_rms, H_avg, &
                                                          & c_sum_Yi_Phi)
                                    call s_compute_speed_of_sound(eos_s_avg, alpha_R, c_avg)
