...
contains
    ...
    subroutine s_hllc_riemann_solver(qL_prim_rsx_vf, qL_prim_rsy_vf, qL_prim_rsz_vf, dqL_prim_dx_vf, & ! ------
        ...
        integer :: i, j, k, l, q !< Generic loop iterators
        integer :: count_to !< Loop Variable - on Line 1464
        integer :: idx1, idxi
        ...
        #:for NORM_DIR, XYZ in [(1, 'x'), (2, 'y'), (3, 'z')]
            ...
            if (norm_dir == ${NORM_DIR}$) then
                ...
                elseif (model_eqns == 2) then
                    !$acc parallel loop collapse(3) gang vector default(present) private(R0_L, R0_R, V0_L, V0_R, P0_L, P0_R, pbw_L, pbw_R, vel_L, vel_R, Re_L, Re_R & 
