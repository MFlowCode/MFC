...
!$acc update device(Res, Re_idx, Re_size)
    ...
    subroutine s_get_viscous(q_prim_vf) ! -------
        ...
        type(vector_field), dimension(1:num_dims) :: dq_prim_dx_qp
        type(vector_field), dimension(1:num_dims) :: dq_prim_dy_qp
        type(vector_field), dimension(1:num_dims) :: dq_prim_dz_qp
        type(vector_field), dimension(1:num_dims) :: gm_vel_qp

        real(kind(0d0)), dimension(:,:,:,:) :: qL_rsx_vf_flat 
        real(kind(0d0)), dimension(:,:,:,:) :: qL_rsy_vf_flat 
        real(kind(0d0)), dimension(:,:,:,:) :: qL_rsz_vf_flat 
        real(kind(0d0)), dimension(:,:,:,:) :: qR_rsx_vf_flat 
        real(kind(0d0)), dimension(:,:,:,:) :: qR_rsy_vf_flat 
        real(kind(0d0)), dimension(:,:,:,:) :: qR_rsz_vf_flat   
        
        real(kind(0d0)), dimension() :: dqL_rsx_vf_flat, 
        real(kind(0d0)), dimension() :: dqL_rsy_vf_flat, 
        real(kind(0d0)), dimension() :: dqL_rsz_vf_flat, 
        real(kind(0d0)), dimension() :: dqR_rsx_vf_flat, 
        real(kind(0d0)), dimension() :: dqR_rsy_vf_flat, 
        real(kind(0d0)), dimension() :: dqR_rsz_vf_flat
