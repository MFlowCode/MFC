...
module m_weno
    ...
    !> @{
    real(kind(0d0)), target, allocatable, dimension(:,:,:,:) :: vL_rs_vf_flat, vR_rs_vf_flat
    !> @}
                ...
                do l = is3%beg, is3%end
                    do k = is2%beg, is2%end
                        do j = is1%beg, is1%end
                            ...
                            dvd(0) = v_rs_wsL_flat(1, j, k, l, i) &
                                     - v_rs_wsL_flat(0, j, k, l, i)
                            dvd(-1) = v_rs_wsL_flat(0, j, k, l, i) &
                                      - v_rs_wsL_flat(-1, j, k, l, i)

                            poly_L(0) = v_rs_wsL_flat(0, j, k, l, i) &
                                        + poly_coef_L(0, 0, j)*dvd(0)
                            poly_L(1) = v_rs_wsL_flat(0, j, k, l, i) &
                            ...
                            poly_R(0) = v_rs_wsL_flat(0, j, k, l, i) &
                                        + poly_coef_R(0, 0, j)*dvd(0)
                            poly_R(1) = v_rs_wsL_flat(0, j, k, l, i) &
                            ...
                            vL_rs_vf_flat(j, k, l, i) = sum(omega_L*poly_L)
                            vR_rs_vf_flat(j, k, l, i) = sum(omega_R*poly_R)
                ...
                do l = is3%beg, is3%end
                    do k = is2%beg, is2%end
                        do j = is1%beg, is1%end
                            ...
                            dvd(1) = v_rs_wsL_flat(2, j, k, l, i) &
                                     - v_rs_wsL_flat(1, j, k, l, i)
                            dvd(0) = v_rs_wsL_flat(1, j, k, l, i) &
                                     - v_rs_wsL_flat(0, j, k, l, i)
                            dvd(-1) = v_rs_wsL_flat(0, j, k, l, i) &
                                      - v_rs_wsL_flat(-1, j, k, l, i)
                            dvd(-2) = v_rs_wsL_flat(-1, j, k, l, i) &
                                      - v_rs_wsL_flat(-2, j, k, l, i)
                            ...
                            poly_L(2) = v_rs_wsL_flat(0, j, k, l, i) &
                            ...
                            dvd(1) = v_rs_wsL(2, j, k, l, i) &
                                     - v_rs_wsL(1, j, k, l, i)
                            dvd(0) = v_rs_wsL(1, j, k, l, i) &
                                     - v_rs_wsL(0, j, k, l, i)
                            dvd(-1) = v_rs_wsL(0, j, k, l, i) &
                                      - v_rs_wsL(-1, j, k, l, i)
                            dvd(-2) = v_rs_wsL(-1, j, k, l, i) &
                                      - v_rs_wsL(-2, j, k, l, i)

                            poly_R(0) = v_rs_wsL(0, j, k, l, i) &
                                        + poly_coef_R(0, 0, j)*dvd(1) &
                                        + poly_coef_R(0, 1, j)*dvd(0)
                            poly_R(1) = v_rs_wsL(0, j, k, l, i) &
                                        + poly_coef_R(1, 0, j)*dvd(0) &
                                        + poly_coef_R(1, 1, j)*dvd(-1)
                            poly_R(2) = v_rs_wsL(0, j, k, l, i) &
...
!$acc update device(is1,is2,is3)
        ...
        allocate (v_rs_wsL_flat(-weno_polyn:weno_polyn, is1%beg:is1%end, &
        ...
        allocate(vL_rs_vf_flat( is1%beg:is1%end, &
            is2%beg:is2%end, is3%beg:is3%end, 1:sys_size))

        allocate(vR_rs_vf_flat(is1%beg:is1%end, &
            is2%beg:is2%end, is3%beg:is3%end, 1:sys_size))

        !$acc enter data create(vL_rs_vf_flat, vR_rs_vf_flat)
                    ...
                    do l = iy%beg, iy%end
                        do k = ix%beg, ix%end
                            do i = -weno_polyn, weno_polyn
                                v_rs_wsL_flat(i,k,l,m,j) =  v_vf(j)%sf(k + i, l, m)
                            end do
                        end do
                    end do
                end do
            ...
            do j = 1, v_size
                do m = iz%beg, iz%end
                    do k = ix%beg, ix%end
                        do l = iy%beg, iy%end
                            do i = -weno_polyn, weno_polyn
                                v_rs_wsL_flat(i,l,k,m,j) =  v_vf(j)%sf(k, l + i, m)
                            end do
                        end do
                    end do
                end do
            ...
            do j = 1, v_size
                do k = ix%beg, ix%end
                    do l = iy%beg, iy%end
                        do m = iz%beg, iz%end
                            do i = -weno_polyn, weno_polyn
                                v_rs_wsL_flat(i,m,l,k,j) =  v_vf(j)%sf(k, l , m + i)
                            end do
                        end do
                    end do
                end do
...
!$acc parallel loop collapse(4) default(present)            
            do i = 1, v_size
                do l = iz%beg, iz%end
                    do k = iy%beg, iy%end
                        do j = ix%beg, ix%end
                            vL_vf(i)%sf(j,k,l) =  vL_rs_vf_flat(j,k,l,i)
                            vR_vf(i)%sf(j,k,l) =  vR_rs_vf_flat(j,k,l,i)
                        end do
                    end do
                end do
            end do 
...
!$acc parallel loop collapse(4) default(present)            
            do i = 1, v_size
                do l = iz%beg, iz%end
                    do j = ix%beg, ix%end
                        do k = iy%beg, iy%end
                            vL_vf(i)%sf(j,k,l) =  vL_rs_vf_flat(k,j,l,i)
                            vR_vf(i)%sf(j,k,l) =  vR_rs_vf_flat(k,j,l,i)
                        end do
                    end do
                end do
            end do 
...
!$acc parallel loop collapse(4) default(present)            
            do i = 1, v_size
                do j = ix%beg, ix%end
                    do k = iy%beg, iy%end
                        do l = iz%beg, iz%end
                            vL_vf(i)%sf(j,k,l) =  vL_rs_vf_flat(l,j,k,i)
                            vR_vf(i)%sf(j,k,l) =  vR_rs_vf_flat(l,j,k,i)
                        end do
                    end do
                end do
            end do 
!$acc end parallel loop
        ...
        do i = 1, v_size
        !$acc update self(vL_vf(i)%sf,vR_vf(i)%sf)
        end do


        ! ==================================================================

        !$acc exit data delete(v_rs_wsL_flat)
        deallocate(v_rs_wsL_flat)

        !$acc exit data delete(vL_rs_vf_flat, vR_rs_vf_flat)
        deallocate (vL_rs_vf_flat, vR_rs_vf_flat)
