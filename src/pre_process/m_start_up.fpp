...
contains
    ...
    impure subroutine s_read_input_file
        ...
        namelist /user_inputs/ case_dir, old_grid, old_ic, t_step_old, t_step_start, m, n, p, x_domain, y_domain, z_domain, &
            ...
            & weno_order, bc_x, bc_y, bc_z, num_patches, hypoelasticity, hypo_energy_guard, mhd, patch_icpp, fluid_pp, bub_pp, &
            & precision, parallel_io, mixlayer_vel_profile, mixlayer_vel_coef, mixlayer_perturb, mixlayer_perturb_nk, &
            & mixlayer_perturb_k0, pi_fac, perturb_flow, perturb_flow_fluid, perturb_flow_mag, perturb_sph, perturb_sph_fluid, &
            & fluid_rho, cyl_coord, loops_x, loops_y, loops_z, rhoref, pref, bubbles_euler, R0ref, nb, polytropic, thermal, Ca, &
            & Web, Re_inv, polydisperse, poly_sigma, qbmm, sigR, sigV, dist_type, rhoRV, file_per_process, relax, relax_model, &
            & palpha_eps, ptgalpha_eps, ib, num_ibs, patch_ib, sigma, adv_n, cfl_adap_dt, cfl_const_dt, n_start, n_start_old, &
