            ...
            do i = 1, nb
                ...
                if (qbmm) then
                    if (dist_type == 1) then
                        ...
                        q_prim_vf(bub_idx%fullmom(i, 2, 0))%sf(j, k, l) = muR**2 + (sigR*rratio)**2
                        q_prim_vf(bub_idx%fullmom(i, 1, 1))%sf(j, k, l) = muR*muV + rhoRV*(sigR*rratio)*(sigV*uratio)
                        q_prim_vf(bub_idx%fullmom(i, 0, 2))%sf(j, k, l) = muV**2 + (sigV*uratio)**2
