...
#:set OpenMP_MODE = "OpenMP"
#:set OpenACC_MODE = "OpenACC"
#:set MFC_OpenMP = (MFC_GPU_MODE == OpenMP_MODE)
#:set MFC_OpenACC = (MFC_GPU_MODE == OpenACC_MODE)
#:set MFC_GPU = (MFC_OpenMP or MFC_OpenACC)
