    ...
    subroutine s_ib_airfoil(patch_id, ib_markers_sf)
        ...
        do j = 0, n
            do i = 0, m
                ...
                xy_local = xy_local + patch_ib(ib_marker)%centroid_offset ! airfoils are a patch that require a centroid offset
        ...
        do l = 0, p
            do j = 0, n
                do i = 0, m
                    ...
                    xyz_local = xyz_local + patch_ib(ib_marker)%centroid_offset ! airfoils are a patch that require a centroid offset
