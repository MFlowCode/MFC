...
module m_constants
    ...
    integer, parameter :: num_patches_max = 10             !< Maximum number of IC patches (patch_icpp)
    integer, parameter :: num_ib_patches_max = 100000      !< Maximum number of immersed boundary patches (patch_ib)
