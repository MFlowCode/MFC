...
contains
    ...
    subroutine s_comp_n_from_prim(vftmp, Rtmp, ntmp, weights)
        ...
        real(kind(0._wp)), dimension(nb), intent(in) :: weights
    ...
    subroutine s_initialize_nonpoly
        ...
        integer :: ir
        real(kind(0._wp)) :: rhol0, pl0, uu, D_m, temp, omega_ref
        real(kind(0._wp)), dimension(Nb) :: chi_vw0, cp_m0, k_m0, rho_m0, x_vw
    ...
    subroutine s_transcoeff(omega, peclet, Re_trans, Im_trans)
        ...
        real(kind(0._wp)), intent(in) :: omega, peclet
        real(kind(0._wp)), intent(out) :: Re_trans, Im_trans
    ...
    subroutine s_simpson
        ...
        integer :: ir
        real(kind(0._wp)) :: R0mn, R0mx, dphi, tmp, sd
