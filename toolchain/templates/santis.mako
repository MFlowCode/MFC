...
export NV_ACC_USE_MALLOC=1                    # use cudaMallocManaged instead of malloc ( compiled using -gpu=mem:unified )
export NVCOMPILER_ACC_NO_MEMHINTS=0           # disable implicit compiler hints
