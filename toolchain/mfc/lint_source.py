...
RUNTIME_CHECKER_SUBROUTINES = {
    # CI-probe interim (up/mega x master integration): up/mega's simulation s_check_inputs still
    # hosts its AMR/feature constraint block; migrating the input-only subset to case_validator
    # is deferred to the real merge, not this integration probe.
    "s_check_inputs",
