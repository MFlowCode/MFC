...
def list_cases() -> typing.List[TestCaseBuilder]:
    ...
    def alter_cfl_modes():
        # Test CFL adaptation mode
        # Note: cfl_const_dt removed due to t_stop conflicts
    ...
    def alter_riemann_solvers(num_fluids):
        # Note: Removed riemann_solver=3 (conflicts with wave_speeds)
        # Note: Removed riemann_solver=4 (requires MHD mode)
