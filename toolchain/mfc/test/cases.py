...
def list_cases() -> typing.List[TestCaseBuilder]:
    ...
    def kernel_golden_tests():
        ...
        # JWL immersed boundary: a products/air blast over a rigid cylinder exercises the
        # JWL ghost-cell energy rebuild (s_jwl_mix_energy_pr through the IB ghost path).
        stack.push(
            "Kernel -> JWL -> IBM",
            {
                "m": 49,
        ...
        cases.append(define_case_d(stack, "", {}, override_tol=1e-7))
        stack.pop()
