...
#./mfc.sh run /anvil/projects/x-mch220010/dfd2023/base/input.py -e batch -p wholenode -w 01:00:00 -# undex -N 2 -n 128 -t simulation -b mpirun

#./mfc.sh run ~/../../anvil/projects/x-mch220010/dfd2023/base_test/input.py -e batch -p wholenode -w 01:00:00 -# base -N 2 -n 128 -t pre_process -b mpirun

./mfc.sh run ~/../../anvil/projects/x-mch220010/test/input_sawyer.py -e batch -p wholenode -w 01:00:00 -# base -N 2 -n 128 -t pre_process -b mpirun
