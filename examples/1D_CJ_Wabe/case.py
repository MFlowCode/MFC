...
sol_L.DPX = 0.351340, 182070.11, "H2:2,O2:1,AR:7"

sol_R = ct.Solution(ctfile)
sol_R.DPX = 0.08498, 6670, "H2:2,O2:1,AR:7"
...
case = {
    ...
    'patch_icpp(2)%hcid'           : 101,
    "patch_icpp(2)%x_centroid": 0.015,
    "patch_icpp(2)%length_x": 0.03,
