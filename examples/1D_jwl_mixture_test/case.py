...
# 1D air + JWL mixing shock tube exercising the linear mass-fraction closure.
...
# so the mixed band 0 < Y < 1 forms at the contact and rides the linear mass-fraction closure.
jwl_A = 3.712e11
jwl_B = 3.231e9
jwl_R1 = 4.15
jwl_R2 = 0.95
