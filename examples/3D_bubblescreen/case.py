...
Nfiles = 20.
Nout   = int(math.ceil(Nt/Nfiles/2))
Nt     = int(2*Nout*Nfiles)
...
print(json.dumps({
    ...
    'y_domain%beg'                 : -5.E-03/x0,
    'z_domain%beg'                 : -5.E-03/x0,
    'x_domain%end'                 :  10.E-03/x0,
    'y_domain%end'                 :  5.E-03/x0,
    'z_domain%end'                 :  5.E-03/x0,
    'stretch_x'                    : 'F',
    'stretch_y'                    : 'F',
    'stretch_z'                    : 'F',
    'cyl_coord'                    : 'F',
    ...
    'patch_icpp(1)%length_y'       : 10.E-03/x0,
    'patch_icpp(1)%length_z'       : 10.E-03/x0,
    'patch_icpp(1)%vel(1)'         : 0.0,
    'patch_icpp(1)%vel(2)'         : 0.0,
    'patch_icpp(1)%vel(3)'         : 0.0,
    'patch_icpp(1)%pres'           : patm,
    'patch_icpp(1)%alpha_rho(1)'   : (1.-1.E-10)*1.E+03/rho0,
    'patch_icpp(1)%alpha(1)'       : 1.E-10,
    'patch_icpp(1)%r0'             : 1.,
    ...
    'patch_icpp(2)%x_centroid'     : -8.E-03/x0,
    'patch_icpp(2)%y_centroid'     : 0.0,
    'patch_icpp(2)%z_centroid'     : 0.0,
    'patch_icpp(2)%length_x'       : 4.E-03/x0,
    'patch_icpp(2)%length_y'       : 10.E-03/x0,
    'patch_icpp(2)%length_z'       : 10.E-03/x0,
    'patch_icpp(2)%vel(1)'         : -0.00341418537,
    'patch_icpp(2)%vel(2)'         : 0.0,
    'patch_icpp(2)%vel(3)'         : 0.0,
    'patch_icpp(2)%pres'           : patm*0.5,
    'patch_icpp(2)%alpha_rho(1)'   : (1.-1.E-10)*1.E+03*0.99997668722/rho0,
    'patch_icpp(2)%alpha(1)'       : 1.E-10,
    'patch_icpp(2)%r0'             : 1.,
    ...
    'patch_icpp(3)%radius'         : 2.5E-03/x0,
    'patch_icpp(3)%alter_patch(1)' : 'T',
    'patch_icpp(3)%vel(1)'         : 0.0,
    'patch_icpp(3)%vel(2)'         : 0.0,
    'patch_icpp(3)%vel(3)'         : 0.0,
    'patch_icpp(3)%pres'           : patm,
    'patch_icpp(3)%alpha_rho(1)'   : (1.-vf0)*1.E+03/rho0,
