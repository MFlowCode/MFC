...
# spurious pressure/velocity oscillation generated by the Rocflu JWL/air mixing
# closure in the WENO-reconstructed mixed band (0 < Y < 1) at each contact. The
# Rocflu closure preserves this state to machine precision (max|p-p0|/p0 ~ 1e-16),
