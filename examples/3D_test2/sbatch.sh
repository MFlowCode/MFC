...
module load nvhpc python
	...
	time srun -N 1 -n 2 -G 2 ../../build/___current___/build/bin/simulation
	#time srun -N 1 -n 2 -G 2 nsys profile ../../build/___current___/build/bin/simulation
	#time srun -N 1 -n 2 -G 2 ncu --set full --cache-control none --clock-control none -k m_weno_s_weno_alt_1433_gpu -f -o WENO_V100_TX2   ../../build/___current___/build/bin/simulation
