    ...
    json.dumps(
        {
            ...
            "parallel_io": "T",
            "fd_order": 2,
            # Patch 1: domain filled with air
            ...
            # STL model referenced by patch 2 (native cube is 0.1^3 -> scale to a centered 5-unit cube)
            "num_stl_models": 1,
            ...
            "stl_models(1)%model_translate(2)": 0,
            "stl_models(1)%model_translate(3)": 0,
