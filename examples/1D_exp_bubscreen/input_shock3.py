...
print(json.dumps({                                                                           \
    ...
    'patch_icpp(1)%x_centroid'     : 0/x0,                     \
    'patch_icpp(1)%length_x'       : 1/x0,                      \
    ...
    'patch_icpp(2)%x_centroid'     : -0.4/x0,                     \
    'patch_icpp(2)%length_x'       : 0.2/x0,                     \
    'patch_icpp(2)%vel(1)'         : 0*cphysical/c0,              \
    'patch_icpp(2)%pres'           : 2.157*patm,                \
    'patch_icpp(2)%alpha_rho(1)'   : (1.-1.E-12)*(1.E+03/rho0), \
    ...
    'patch_icpp(3)%x_centroid'     : 0/x0,                        \
    'patch_icpp(3)%length_x'       : 1/x0,                 \
