#!/usr/bin/env python3
"""2D hypoelastic acoustic case (default HLLD): liquid + solid square, focused acoustic source.
   Base for HLL/HLLC/HLLD tests. Resolution 49^2; riemann_solver=4 (HLLD); wave_speeds=1, avg_state=2, alt_soundspeed=T, mpp_lim=F."""
import json
