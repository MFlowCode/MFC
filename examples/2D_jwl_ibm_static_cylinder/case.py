#!/usr/bin/env python3
# Inert products blast over a static rigid cylinder. A full-density TNT-products
# charge on the y=0 axis is released instantaneously (no program burn, no
# reaction) and drives a shock into ambient air; the shock strikes a fixed rigid
# cylinder centered on the axis. This exercises the JWL immersed-boundary ghost
# cell: the near-body energy is rebuilt through the JWL closure, not the
# stiffened-gas relation. Charge and cylinder both sit on y=0, so a correct run
# stays mirror-symmetric about the axis to round-off.
    ...
    json.dumps(
        {
            ...
            "parallel_io": "F",
            "ib_state_wrt": "T",
            # Static rigid cylinder centered on the y=0 axis.
            "ib": "T",
            "num_ibs": 1,
            "fd_order": 2,
